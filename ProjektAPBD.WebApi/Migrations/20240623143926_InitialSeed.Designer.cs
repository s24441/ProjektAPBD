...
namespace ProjektAPBD.WebApi.Migrations
{
    ...
    [Migration("20240623143926_InitialSeed")]
            ...
            modelBuilder.Entity("ProjektAPBD.WebApi.Models.Entities.Discount", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            IdDiscount = 1,
                            DateFrom = new DateTime(2024, 6, 3, 16, 39, 26, 62, DateTimeKind.Local).AddTicks(9939),
                            DateTo = new DateTime(2024, 8, 2, 16, 39, 26, 62, DateTimeKind.Local).AddTicks(9964),
                            IdSoftwareProduct = 1,
                            PercentageValue = 20
                        },
                        new
                        {
                            IdDiscount = 2,
                            DateFrom = new DateTime(2024, 6, 13, 16, 39, 26, 62, DateTimeKind.Local).AddTicks(9967),
                            DateTo = new DateTime(2024, 8, 12, 16, 39, 26, 62, DateTimeKind.Local).AddTicks(9968),
                            IdSoftwareProduct = 1,
                            PercentageValue = 25
                        },
                        new
                        {
                            IdDiscount = 3,
                            DateFrom = new DateTime(2024, 6, 3, 16, 39, 26, 62, DateTimeKind.Local).AddTicks(9971),
                            DateTo = new DateTime(2024, 6, 13, 16, 39, 26, 62, DateTimeKind.Local).AddTicks(9972),
                            IdSoftwareProduct = 2,
                            PercentageValue = 50
                        },
                        new
                        {
                            IdDiscount = 4,
                            DateFrom = new DateTime(2024, 6, 22, 16, 39, 26, 62, DateTimeKind.Local).AddTicks(9975),
                            DateTo = new DateTime(2024, 7, 23, 16, 39, 26, 62, DateTimeKind.Local).AddTicks(9979),
                            IdSoftwareProduct = 2,
                            PercentageValue = 20
                        });
                });
            ...
            modelBuilder.Entity("ProjektAPBD.WebApi.Models.Entities.SoftwareProduct", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            IdSoftwareProduct = 1,
                            ActualVersion = "2.1",
                            ActualVersionReleaseDate = new DateTime(2024, 3, 15, 16, 39, 26, 64, DateTimeKind.Local).AddTicks(2038),
                            Category = "Rozrywka",
                            Description = "Super aplikacja do rozrywki",
                            Name = "SuperSoft"
                        },
                        new
                        {
                            IdSoftwareProduct = 2,
                            ActualVersion = "7.8",
                            ActualVersionReleaseDate = new DateTime(2024, 6, 3, 16, 39, 26, 64, DateTimeKind.Local).AddTicks(2049),
                            Category = "Design gier",
                            Description = "Interaktywny progam do tworenia gier",
                            Name = "GamexPro"
                        },
                        new
                        {
                            IdSoftwareProduct = 3,
                            ActualVersion = "1.0",
                            ActualVersionReleaseDate = new DateTime(2024, 4, 19, 16, 39, 26, 64, DateTimeKind.Local).AddTicks(2052),
                            Category = "Rozwój osobisty",
                            Description = "Inteligentny organizer, ktory zawsze przypomni o najważniejszych wydarzeniach",
                            Name = "Alerter"
                        });
                });
            ...
            modelBuilder.Entity("ProjektAPBD.WebApi.Models.Entities.Company", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            IdClient = 1,
                            Address = "Koszykowa 24",
                            Email = "evil@corp.com",
                            Phone = "666-333-111",
                            KrsNumber = "0000772427",
                            Name = "EvilCorp"
                        },
                        new
                        {
                            IdClient = 2,
                            Address = "Instalatorów 9/24C",
                            Email = "instpol@gmail.com",
                            Phone = "738-091-364",
                            KrsNumber = "0000766811",
                            Name = "InstPol"
                        },
                        new
                        {
                            IdClient = 3,
                            Address = "Banacha 50A",
                            Email = "plytex@company.pl",
                            Phone = "(22)824-79-21",
                            KrsNumber = "0000724592",
                            Name = "PłyteX"
                        });
                });
            ...
            modelBuilder.Entity("ProjektAPBD.WebApi.Models.Entities.PhysicalPerson", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            IdClient = 4,
                            Address = "Duracza 76/21",
                            Email = "amichalecki@gmail.com",
                            Phone = "726-487-621",
                            FirstName = "Andrzej",
                            LastName = "Michalecki",
                            Pesel = "89050729992"
                        ...
                        {
                            IdClient = 6,
                            Address = "Partyzantki 12C",
                            Email = "plytex@company.pl",
                            Phone = "(+48)842-279-216",
                            FirstName = "Anna",
                            LastName = "Łącka",
                            Pesel = "08280732893"
                        });
